...
description: 在一個步驟中提案一個新變更並產生所有構件 (artifacts)。當使用者想要快速描述他們想要建置的內容，並取得包含準備實作的設計、規格與工作的完整提案時使用。
license: MIT
...
**輸入**：使用者的請求應包含變更名稱 (kebab-case) 或使用者想要建置內容的描述。

**步驟**

1. **如果未提供明確輸入，詢問他們想要建置什麼**
...
- 提示："執行 `/opsx:apply` 或要求我實作以開始處理工作項目。"
